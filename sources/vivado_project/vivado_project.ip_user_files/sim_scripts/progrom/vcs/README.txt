...
#
# Generated by export_simulation on Mon Feb 19 23:35:11 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './progrom.sh' script.

./progrom.sh -reset_run
...
./progrom.sh -noclean_files

For more information on the script, please type './progrom.sh -help'.
